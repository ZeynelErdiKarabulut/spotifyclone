package com.example.spotifyclone.viewmodels.homefeedviewmodel
...
import com.example.spotifyclone.data.repositories.homefeedrepository.ISO6391LanguageCode
...
import com.example.spotifyclone.domain.*
...
class HomeFeedViewModel @Inject constructor(
    ...
    private fun fetchAndAssignHomeFeedCarousels() {
        viewModelScope.launch {
            ...
            val languageCode =
                getApplication<SpotifyCloneApplication>().resources.configuration.locale.language.let(::ISO6391LanguageCode) // TODO test
     ...
     */
    private suspend fun <FetchedResourceType> Deferred<FetchedResource<FetchedResourceType, spotifycloneErrorType>>.awaitFetchedResourceUpdatingUiState(
     ...
     */
    private suspend fun <FetchedResourceType> Deferred<FetchedResource<FetchedResourceType, spotifycloneErrorType>>.awaitFetchedResource(
        onError: (spotifycloneErrorType) -> Unit, onSuccess: (FetchedResourceType) -> Unit
    ) {
