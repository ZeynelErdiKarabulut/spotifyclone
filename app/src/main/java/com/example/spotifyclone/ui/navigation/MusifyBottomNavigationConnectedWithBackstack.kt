...
import com.example.spotifyclone.ui.components.spotifycloneBottomNavigation
 ...
 */
@Composable
fun spotifycloneBottomNavigationConnectedWithBackStack(
    ...
    var previousValidBottomNavigationDestination by remember {
        mutableStateOf<spotifycloneBottomNavigationDestinations>(spotifycloneBottomNavigationDestinations.Home)
    }
    val currentlySelectedItem by remember {
        derivedStateOf {
            ...
            // spotifycloneBottomNavigationDestinations sealed classes, then
            ...
            // is a child of spotifycloneBottomNavigationDestinations sealed class,
            // then store it in a variable and update the state.
            // Essentially, it is picking the most recent valid route that
            // matches the route of a class that is a child of spotifycloneBottomNavigationDestinations
            // sealed class.
            currentBackStackEntry?.let {
                ...
                previousValidBottomNavigationDestination = when (route) {
                    spotifycloneBottomNavigationDestinations.Home.route -> spotifycloneBottomNavigationDestinations.Home
                    spotifycloneBottomNavigationDestinations.Search.route -> spotifycloneBottomNavigationDestinations.Search
                    spotifycloneBottomNavigationDestinations.Premium.route -> spotifycloneBottomNavigationDestinations.Premium
