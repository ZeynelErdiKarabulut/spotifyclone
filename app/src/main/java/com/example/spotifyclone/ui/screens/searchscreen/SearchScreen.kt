package com.example.spotifyclone.ui.screens.searchscreen
...
import com.example.spotifyclone.ui.components.*
...
private fun SearchQueryList(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        if (isSearchErrorMessageVisible) {
            ...
            LazyColumn(
                ...
                contentPadding = PaddingValues(
                    bottom = spotifycloneBottomNavigationConstants.navigationHeight + spotifycloneMiniPlayerConstants.miniPlayerHeight
                ),
            ) {
        ...
        val spotifycloneLoadingAnimationModifier = if (WindowInsets.isImeVisible) {
            Modifier
                .align(Alignment.Center)
                .imePadding()
        } else {
            Modifier
                .align(Alignment.Center)
                .padding(
                    bottom = spotifycloneMiniPlayerConstants.miniPlayerHeight + spotifycloneBottomNavigationConstants.navigationHeight
                )
        }
        DefaultspotifycloneLoadingAnimation(
            modifier = spotifycloneLoadingAnimationModifier,
