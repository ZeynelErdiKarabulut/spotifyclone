 ...
 * track. This is a wrapper over [com.example.spotifyclone.ui.components.spotifycloneCompactListItemCard].
...
@Composable
fun spotifycloneCompactTrackCard(
    ...
    contentPadding: PaddingValues = spotifycloneCompactTrackCardDefaults.defaultContentPadding
) {
    ...
    CompositionLocalProvider(
        ...
        spotifycloneCompactListItemCard(
            modifier = modifier,
...
/**
 * Contains default values used by [spotifycloneCompactTrackCard].
 */
object spotifycloneCompactTrackCardDefaults {
