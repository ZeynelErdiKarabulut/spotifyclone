...
import com.example.spotifyclone.ui.components.GenreCard
...
fun GenresGrid(
    ...
    LazyVerticalGrid(
        ...
        item(span = { GridItemSpan(this.maxLineSpan) }) {
            Spacer(
                modifier = Modifier
                    .height(spotifycloneBottomNavigationConstants.navigationHeight + spotifycloneMiniPlayerConstants.miniPlayerHeight)
